...
- The function `distinct()` (from `dplyr`) will remove duplicate rows
    + Only across the provided columns
...
4. Can you use `slice_max()` to return the same penguins as the final example, i.e. the heaviest from each species and island?    
