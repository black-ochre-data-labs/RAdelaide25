...
- Spreadsheet-like data is very common (e.g. `penguins`)
- Is known as a `data.frame`
    ...
    + Is just a `data.frame` with some convenient features
...
- This is our dataset as a simple `.csv` file
...
- Useful for very large objects (e.g. if we had 1000 guinea penguins)
