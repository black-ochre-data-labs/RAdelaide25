...
| | Visualising Your Data with `ggplot2` | [Introductory Visualisation](intro_vis.html) | `r getTiming("intro_vis_slides.qmd", 1.5)` |
| 3:00  | *Afternoon Tea* | | |
...
|:----- |:----- |:----- |:-------- |
| 9:00 | Using `stringr` to Modify Text (continued) | [Working With Text](text.html) | `r getTiming("text_slides.qmd", 1.2)` |
