...
|  | Exploring Spreadsheet-Like Data   | [Exploring Penguins](penguins.html) | `r getTiming("penguin_slides.qmd", 1.2)`|
| 10:30 | *Morning Tea* | | |
...
| | Reshaping Data With `tidyr` | [Reshaping Data](tidying.html) | `r getTiming("tidying_slides.qmd", 1.2)` |
| 12:30 | *Lunch* | | |
| 1:30  | Visualising Your Data with `ggplot2` | [Introductory Visualisation](intro_vis.html) | `r getTiming("intro_vis_slides.qmd", 1.5)` |
| 3:00  | *Afternoon Tea* | | |
| 3:30 | Using `stringr` to Modify Text | [Working With Text](text.html) | `r getTiming("text_slides.qmd", 1.2)` |
