...
![](https://smped.github.io/motifTestR/reference/figures/favicon.png){.absolute bottom=450 right=0 width='120px'}

![](https://github.com/smped/ngsReports/blob/devel/man/figures/ngsReports.png?raw=true){.absolute bottom=350 right=90 width='120px'}

![](https://github.com/smped/extraChIPs/blob/devel/man/figures/extraChIPs.png?raw=true){.absolute bottom=250 right=0 width='120px'}


![](https://smped.github.io/transmogR/reference/figures/transmogR.png){.absolute bottom=150 right=90 width='120px'}
...
- Room is considered a wet lab $\implies$ *no drinks*
...
- You can ask them to write code for you
    + They will often get it wrong
    + *You will not understand how to use R*
- If I ask ChatGPT to write code for me $\rightarrow$ mine is usually better
    
. . .

- I do sometimes use ChatGPT or Claude.ai to help me write code
    + I ask for help in less familiar languages (e.g. C, python)
    + I ask it to help me write documentation or comment code
    + I sometimes have it running as a "co-pilot"
...
- I first found R in 2002, which was v1.4
:::    
